...
const isAdultPresent = devs.some(dev => dev.age = 18);
...
const idx = comments.findIndex(comment => comment.id === targetId);
...
// - Accumulate this lifespan jl.in the 'totalYearsLived' variable.
